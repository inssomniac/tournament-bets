      ...
      <div className="lp-scroll" style={{ marginTop: -16, padding: '20px 16px 32px' }}>
        ...
        <div className="lp-marquee" style={{ margin: '0 -16px 24px' }}>
          <div className="lp-marquee-track">
            ...
            <span className="lp-marquee-text">ПРОМОКОД &nbsp;·&nbsp; ОЧКИ &nbsp;·&nbsp; СТАВКИ &nbsp;·&nbsp; ПОБЕДА &nbsp;·&nbsp; ПРОМОКОД &nbsp;·&nbsp; ОЧКИ &nbsp;·&nbsp; СТАВКИ &nbsp;·&nbsp; ПОБЕДА &nbsp;·&nbsp; ПРОМОКОД &nbsp;·&nbsp; ОЧКИ &nbsp;·&nbsp; СТАВКИ &nbsp;·&nbsp; ПОБЕДА &nbsp;·&nbsp; ПРОМОКОД &nbsp;·&nbsp; ОЧКИ &nbsp;·&nbsp; СТАВКИ &nbsp;·&nbsp; ПОБЕДА &nbsp;·&nbsp; ПРОМОКОД &nbsp;·&nbsp; ОЧКИ &nbsp;·&nbsp; СТАВКИ &nbsp;·&nbsp; ПОБЕДА &nbsp;·&nbsp; </span>
          </div>
        </div>
